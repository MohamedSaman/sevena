        ...
        <div class="card p-6 mb-6 bg-white rounded-xl shadow-sm">
            ...
            <form wire:submit.prevent="saveProductionEntry" id="production-form">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-1">Rate per Quantity (LKR)</label>
                        <input type="number" wire:model="form.per_rate"
                            class="form-control w-full border border-gray-300 rounded-md p-2 bg-gray-100"
                            placeholder="Select role to see rate" disabled>
                        @error('form.per_rate') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                    </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="text-left px-4 py-3">Worked Qty</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">{{ number_format($record->per_rate, 0) }}</td>
                    ...
                    <div class="p-6">
                        ...
                        <form wire:submit.prevent="updateRecord">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium mb-1">Rate per (LKR)</label>
                                    <input type="number" wire:model="form.per_rate"
                                        class="form-control w-full border border-gray-300 rounded-md p-2"
